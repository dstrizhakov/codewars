...
// Be sure to handle passing array indices. For example, if we have an
// object: { people: ['John', 'Dave', 'Lisa'] } and the path is 'people.1',
...
// { user: { name: 'Dan' } } and the path is 'user.wallet.money', we should
// return undefined. Valid paths are exclusive to properties on the object which
// are not inherited, in other words it is specific to this object and does not need

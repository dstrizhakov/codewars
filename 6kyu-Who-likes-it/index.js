...
function likes(names) {
	switch (names.length) {
		case 0:
			variant = "no one likes this";
			break;
		case 1:
			variant = `${names[0]} likes this`;
			break;
		case 2:
			variant = `${names[0]} and ${names[1]} like this`;
			break;
		case 3:
			variant = `${names[0]}, ${names[1]} and ${names[2]} like this`;
			break;
		default:
			variant = `${names[0]}, ${names[1]} and ${names.length - 2} others like this`;
	}
	return variant
}